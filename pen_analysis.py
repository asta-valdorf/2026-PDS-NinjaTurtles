...
def show_pen_result(image_path):
    """
    visualization of pen detection and removal.
    Displays:
    - Original image
    - Blue pen candidate mask
    - Black pen candidate mask
    - Final pen mask after dilation
    - Cleaned image after inpainting
    """
    ...
    # detect pen regions and decide whether to apply inpainting
